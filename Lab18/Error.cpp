...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(134, "[ITable]: Ошибка получения элемента из таблицы идентификаторов: элемент не создан или выходит за диапозон"), // +
		ERROR_ENTRY(135, "[LTable]: Ошибка получения элемента из таблицы литералов: элемент не создан или выходит за границы массива"), // +
