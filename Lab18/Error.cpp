...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY_NODEF(91),
		ERROR_ENTRY_NODEF(92),
		...
		ERROR_ENTRY(119, "[LT]: Найдено несколько точек входа"),
		ERROR_ENTRY(120, "[LT]: Ключевое слово используется как индификатор"),
		ERROR_ENTRY(121, "[LT]: Используется необъявленный идентификатор"), // +
		ERROR_ENTRY(122, "[LT]: идентификатор не распознан"),
